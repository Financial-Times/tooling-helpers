...
describe("handler", () => {
    ...
    test("calls the appropriate message formatter based on the entry's `event`", () => {
        ...
        const formatterMethodNames = Object.keys(messageFormatters)
            .filter((formatterName) => formatterName !== 'handler');
...
describe("requireDependency", () => {
    ...
    test("returns a correctly formatted message", () => {
        ...
        ).toEqual("Required package jest@24.0.0 in devDependencies (new dependency)");
        ...
        ).toEqual("Required package jest@24.0.0 in devDependencies, previously 23.0.0");
...
describe("requireScript", () => {
    ...
    test("returns a correctly formatted message", () => {
        ...
        ).toEqual("Required script for lifecycle event 'start' (new script)");
        ...
        ).toEqual("Required script for lifecycle event 'start' (overwrote existing command)");
